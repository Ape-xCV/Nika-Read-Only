...
powershell -Command "(Get-Content %DEV%.inf).Replace('1AF4&DEV_1000&SUBSYS_00011AF4&REV_00, PCI\VEN_1AF4&DEV_1000', '8086&DEV_%DEV%&SUBSYS_00018086&REV_00, PCI\VEN_8086&DEV_%DEV%').Replace('kvmnet6', 'oemnet').Replace('netkvmp', '%DEV%') | Out-File -encoding Ascii %DEV%.txt"
fc %DEV%.inf %DEV%.txt
