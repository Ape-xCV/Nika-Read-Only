...
echo "t->processor_family = 0xfe;                       -> t->processor_family = g_type4_family;"
...
echo "t->processor_upgrade = 0x01;                      -> t->processor_upgrade = g_type4_upgrade;"
...
sed -i "$file_smbios" -Ee "s/t->processor_family = 0xfe;/t->processor_family = g_type4_family;/"
...
sed -i "$file_smbios" -Ee "s/t->processor_upgrade = 0x01;/t->processor_upgrade = g_type4_upgrade;/"
