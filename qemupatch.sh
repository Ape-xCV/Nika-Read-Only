...
echo "physical_memory_array_handle = cpu_to_le16(0x1000) -> physical_memory_array_handle = cpu_to_le16(T16_BASE)"
...
sed -i "$file_smbios" -Ee "s/physical_memory_array_handle = cpu_to_le16\(0x1000\)/physical_memory_array_handle = cpu_to_le16(T16_BASE)/"
