...
echo "t->bus_number = 0xff;                           -> t->bus_number = t9->slot_id;"
#echo "t->device_number = 0xff;                        -> t->device_number = 0x00;"
sed -i "$file_smbios" -Ee "s/t->segment_group_number = 0xff;/t->segment_group_number = cpu_to_le16(0);/"
sed -i "$file_smbios" -Ee "s/t->bus_number = 0xff;/t->bus_number = t9->slot_id;/"
#sed -i "$file_smbios" -Ee "s/t->device_number = 0xff;/t->device_number = 0x00;/"
