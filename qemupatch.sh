...
default_models=(
  "CT250MX500SSD1" "EMTCE X150 240GB"
...
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->maximum_cache_size = 0xFFFE;              // 2047.8 MiB"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->installed_size = 0xFFFE;"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->supported_sram_type = 0b0000000000110000; // 0000000000 Synchronous(1) PipelineBurst(1) 0000"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->current_sram_type = 0b0000000000110000;"
...
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->system_cache_type = 0x04;                 // Data"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->associativity = 0x06;                     // Fully Associative"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->maximum_cache_size_2 = 0x80007FFE;        // 2047.8 MiB"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->installed_size_2 = 0x80007FFE;"
...
sed -i "$file_smbios" -Ee "/    SMBIOS_SET_DEFAULT\(type17.manufacturer, manufacturer\);/a\    SMBIOS_SET_DEFAULT(type7.socket_designation, \"CACHE0\");"
