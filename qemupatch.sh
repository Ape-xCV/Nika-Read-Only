...
sed -i "$file_smbios" -Ee "s/l1_cache_handle = cpu_to_le16\(0xFFFF\)/l1_cache_handle = cpu_to_le16(T7_BASE + 0b000)/"
sed -i "$file_smbios" -Ee "s/l2_cache_handle = cpu_to_le16\(0xFFFF\)/l2_cache_handle = cpu_to_le16(T7_BASE + 0b001)/"
sed -i "$file_smbios" -Ee "s/l3_cache_handle = cpu_to_le16\(0xFFFF\)/l3_cache_handle = cpu_to_le16(T7_BASE + 0b010)/"
...
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/istatic void smbios_build_type_7_table(unsigned instance, uint16_t installed_size, uint32_t installed_size_2)"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i{"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    SMBIOS_BUILD_TABLE_PRE(7, T7_BASE + instance, true); /* required */"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->cache_configuration = 0b0000000100000000 | instance; // 000000 WriteBack(01) Disabled(0) Internal(00) 0 NotSocketed(0) L1(000)"
...
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    t->system_cache_type = 0x05;                            // Unified"
...
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    if      (instance == 0b000) SMBIOS_TABLE_SET_STR(7, socket_designation, type7.socket_designation_l1);"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    else if (instance == 0b001) SMBIOS_TABLE_SET_STR(7, socket_designation, type7.socket_designation_l2);"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_8_table\(void\)/i\    else if (instance == 0b010) SMBIOS_TABLE_SET_STR(7, socket_designation, type7.socket_designation_l3);"
...
sed -i "$file_smbios" -Ee "/static void smbios_build_type_32_table\(void\)/i\    t->maximum_value = 0x4000;           // in millivolts"
sed -i "$file_smbios" -Ee "/static void smbios_build_type_32_table\(void\)/i\    t->minimum_value = 0;                // in millivolts"
...
echo "    smbios_build_type_7_table(0b000, 0x0300, 0x00000300); // L1 768 KiB"
echo "    smbios_build_type_7_table(0b001, 0x3000, 0x00003000); // L2 12 MiB"
echo "    smbios_build_type_7_table(0b010, 0x8400, 0x80000400); // L3 64 MiB"
echo "    ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^"
echo "    smbios_build_type_8_table();"
sed -i "$file_smbios" -Ee "/    smbios_build_type_8_table\(\);/i\    smbios_build_type_7_table(0b000, 0x0300, 0x00000300); // L1 768 KiB"
sed -i "$file_smbios" -Ee "/    smbios_build_type_8_table\(\);/i\    smbios_build_type_7_table(0b001, 0x3000, 0x00003000); // L2 12 MiB"
sed -i "$file_smbios" -Ee "/    smbios_build_type_8_table\(\);/i\    smbios_build_type_7_table(0b010, 0x8400, 0x80000400); // L3 64 MiB"
