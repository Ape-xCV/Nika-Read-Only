...
echo "    snprintf(serial_str, sizeof(serial_str), \"%d\", rand());"
sed -i "$file_smbios" -Ee "/    SMBIOS_TABLE_SET_STR\(17, manufacturer_str, type17.manufacturer\);/a\    snprintf(serial_str, sizeof(serial_str), \"%d\", rand());"
