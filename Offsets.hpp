...
constexpr long OFF_LEVEL_NAME = 0x1836670 + 0x01c4; //[Miscellaneous]->ClientState + 0x01c4
constexpr long OFF_PROJECTILE_SPEED = 0x04ec + 0x19d8; //[Miscellaneous]->CPlayer!camera_origin - 0x1c //[WeaponSettings]->projectile_launch_speed + [WeaponSettingsMeta]->base
...
// [IDA]
constexpr long OFF_OBSERVER_LIST = 0x01f621d0 + 0x20c8; //[ConVars]->gamepad_aim_assist_melee + 0x20c8 //IDA signature >> [48 8B 0D ? ? ? ? 48 85 C9 74 ? 48 8B 01 FF ? ? 48 85 C0 74 ? 48 63 4E 38]
constexpr long OFF_OBSERVER_ARRAY = 0x0974; //[RecvTable.DT_GlobalNonRewinding]->m_gameTimescale //IDA signature >> [8B 84 C8 ? ? ? ? 83 F8]
