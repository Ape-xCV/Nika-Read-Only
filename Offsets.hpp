...
// [Miscellaneous]
constexpr char OFF_GAME_VERSION[] = "v3.0.79.44"; //[Miscellaneous]->GameVersion
...
constexpr long OFF_VIEW_RENDER = 0x769b558; //[Miscellaneous]->ViewRender
constexpr long OFF_VIEW_MATRIX = 0x11a350; //[Miscellaneous]->ViewMatrix
constexpr long OFF_LEVEL_NAME = 0x17ec544; //[Miscellaneous]->LevelName
...
// [ConVars]
constexpr long OFF_GAME_MODE = 0x02421250; //[ConVars]->mp_gamemode
// [Static]
constexpr long OFF_REGION = 0x140000000; //[Static]->Region
// [IDA]
constexpr long OFF_OBSERVER_LIST = 0x1f17fa8; //IDA signature >> [48 8B 0D ? ? ? ? 48 85 C9 74 ? 48 8B 01 FF ? ? 48 85 C0 74 ? 48 63 4E 38]
