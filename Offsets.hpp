...
// [Miscellaneous]
constexpr std::string OFF_GAME_VERSION = "v3.0.79.48"; //[Miscellaneous]->GameVersion
...
constexpr long OFF_NAMELIST = 0xd3c9f50; //[Miscellaneous]->NameList
constexpr long OFF_VIEW_RENDER = 0x76dd058; //[Miscellaneous]->ViewRender
...
// [IDA]
constexpr long OFF_OBSERVER_LIST = 0x1f57fd8; //IDA signature >> [48 8B 0D ? ? ? ? 48 85 C9 74 ? 48 8B 01 FF ? ? 48 85 C0 74 ? 48 63 4E 38]
