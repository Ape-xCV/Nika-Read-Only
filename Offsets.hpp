...
// [IDA]
constexpr long OFF_OBSERVER_LIST = 0x01f63068; //[ConVars]->gamepad_aim_assist_melee + 0x20c8 //IDA signature >> [48 8B 0D ? ? ? ? 48 85 C9 74 ? 48 8B 01 FF ? ? 48 85 C0 74 ? 48 63 4E 38]
constexpr long OFF_OBSERVER_ARRAY = 0x978; //[RecvTable.DT_GlobalNonRewinding]->m_playerObserver
