...
// [Miscellaneous]
constexpr char OFF_GAME_VERSION[] = "v3.0.80.16"; //[Miscellaneous]->GameVersion
...
constexpr long OFF_VIEW_RENDER = 0x76a7c38; //[Miscellaneous]->ViewRender
constexpr long OFF_VIEW_MATRIX = 0x11a350; //[Miscellaneous]->ViewMatrix
constexpr long OFF_LEVEL_NAME = 0x17f66c4; //[Miscellaneous]->LevelName
...
// [ConVars]
constexpr long OFF_GAME_MODE = 0x0242d460; //[ConVars]->mp_gamemode
// [Static]
